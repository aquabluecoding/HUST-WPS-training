...
namespace TinySTL
{
	...
	public:
		...
		explicit KVector(const size_type n);
		KVector(const size_type n, const value_type& value);
		template<class InputIterator>
		KVector(InputIterator first, InputIterator last);
	...
	public:
		...
		friend bool operator == (const KVector<T, Alloc>& v1, const KVector<T, Alloc>& v2);
		template<class T, class Alloc>
		friend bool operator != (const KVector<T, Alloc>& v1, const KVector<T, Alloc>& v2);
	};// end of class vector
}

#include "Detail\kvector_impl.h"
#endif